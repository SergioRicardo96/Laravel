...
<!-- SCRIPT PARA PODER HACER LA VALIDACION DEL CORREO y CHECAR SI ESTA DISPONIBLE-->
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result == 'unique')
                    {
                        ...
                        $('#error_email').html('<label class="text-success">Disponible.</label>');
                        $('#email').removeClass('has-error');
                        $('#register').attr('disabled', false);
                    }
                    else
                    {
                        $('#error_email').html('<label class="text-danger">Ya existe una cuenta con esta dirección de correo electrónico.</label>');
                        $('#email').addClass('has-error');
                        $('#register').attr('disabled', 'disabled');
                    }
                }
